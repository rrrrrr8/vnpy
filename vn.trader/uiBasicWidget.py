...
########################################################################
class IntCell(QtGui.QTableWidgetItem):
    """用来显示整数的单元格"""

    #----------------------------------------------------------------------
    def __init__(self, text=None, mainEngine=None):
        """Constructor"""
        super(IntCell, self).__init__()
        self.data = None
        if text:
            self.setContent(text)
...
########################################################################
class FloatCell(QtGui.QTableWidgetItem):
    """用来显示浮点数的单元格"""

    #----------------------------------------------------------------------
    def __init__(self, text=None, mainEngine=None):
        """Constructor"""
        super(FloatCell, self).__init__()
        self.data = None
        if text:
            self.setContent(text)
...
class MarketMonitor(BasicMonitor):
    ...
    def __init__(self, mainEngine, eventEngine, parent=None):
        ...
        d['lastPrice'] = {'chinese':u'最新价', 'cellType':FloatCell}
        d['preClosePrice'] = {'chinese':u'昨收盘价', 'cellType':FloatCell}
        d['volume'] = {'chinese':u'成交量', 'cellType':IntCell}
        d['openInterest'] = {'chinese':u'持仓量', 'cellType':IntCell}
        d['openPrice'] = {'chinese':u'开盘价', 'cellType':FloatCell}
        d['highPrice'] = {'chinese':u'最高价', 'cellType':FloatCell}
        d['lowPrice'] = {'chinese':u'最低价', 'cellType':FloatCell}
